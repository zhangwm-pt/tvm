...
/*!
 * \file codegen_riscv.h
 * \brief Common utilities to generated C style code.
 */
#ifndef TVM_TARGET_SOURCE_CODEGEN_RISCV_H_
#define TVM_TARGET_SOURCE_CODEGEN_RISCV_H_
 ...
 *
 *  CodeGenRiscv have two modes: generate SSA formed C code or normal form.
 *
 * **NOTE** CodeGenRiscv does not aim at generating C codes consumed by MSVC or GCC,
 ...
 */
class CodeGenRiscv : public ExprFunctor<void(const PrimExpr&, std::ostream&)>,
 ...
 public:
  ...
  std::string Finish();
  /*!
   * \brief Print the Stmt n to CodeGenRiscv->stream
  ...
  void print_ostream(std::ostringstream t) { std::cout << t.str(); }
...
#endif  // TVM_TARGET_SOURCE_CODEGEN_RISCV_H_
