...
/*!
 * \file codegen_c_riscv.h
 * \brief Generate C host code.
 */
#ifndef TVM_TARGET_SOURCE_CODEGEN_C_RISCV_H_
#define TVM_TARGET_SOURCE_CODEGEN_C_RISCV_H_
...
class CodeGenCRiscv : public CodeGenRiscv {
 public:
  CodeGenCRiscv();
...
#endif  // TVM_TARGET_SOURCE_CODEGEN_C_RISCV_H_
