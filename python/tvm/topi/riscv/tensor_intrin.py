    ...
    def _intrin_func(ins, outs):
        def _instr(index):
            ...
            if int32_lanes == 4:
                ...
                int_8xl = "int8x16"
                int_32xl = "int32x4"
                pmaddubs = "llvm.riscv.ssse3.pmadd.ub.sw.128"
                pmaddw = "llvm.riscv.sse2.pmadd.wd"
            elif int32_lanes == 8:
                int_lx32 = "int16x16"
                int_8xl = "int8x32"
                int_32xl = "int32x8"
                pmaddubs = "llvm.riscv.avx2.pmadd.ub.sw"
                pmaddw = "llvm.riscv.avx2.pmadd.wd"
            elif int32_lanes == 16:
                int_lx32 = "int16x32"
                int_8xl = "int8x64"
                int_32xl = "int32x16"
                pmaddubs = "llvm.riscv.avx512.pmaddubs.w.512"
                pmaddw = "llvm.riscv.avx512.pmaddw.d.512"
    ...
    def _intrin_func(ins, outs):
        def _instr(index):
            ...
            for i in range(4):
                ...
                pair_reduction = tvm.tir.call_llvm_pure_intrin(
                    "int16x32",
                    "llvm.riscv.avx512.pmaddubs.w.512",
                    tvm.tir.const(0, "uint32"),
                    vec_a,
                    vec_b,
                )
...
def dot_16x1x16_uint8_int8_int32_cascadelake():
    ...
    def _intrin_func(ins, outs):
        def _instr(index):
            ...
            vnni_inst_name = "llvm.riscv.avx512.vpdpbusd.512"
            ...
            if llvm_id != 0:  # VNNI is available for current LLVM version
                ...
                quad_reduction = tvm.tir.call_llvm_pure_intrin(
                    "int32x16",
                    "llvm.riscv.avx512.vpdpbusd.512",
                    tvm.tir.const(0, "uint32"),
                    vec_zero,
                    vec_ai32,
                    vec_bi32,
                ...
                quad_reduction = tvm.tir.call_llvm_pure_intrin(
                    "int32x16",
                    "llvm.riscv.avx512.pmaddw.d.512",
                    tvm.tir.const(0, "uint32"),
                    pair_reduction,
                    vec_one,
                )
