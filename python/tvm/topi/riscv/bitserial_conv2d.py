...
"""Bitserial conv2d schedule on riscv"""
import tvm
from tvm import te
...
@autotvm.register_topi_compute("bitserial_conv2d_nchw.riscv")
...
@autotvm.register_topi_compute("bitserial_conv2d_nhwc.riscv")
...
@autotvm.register_topi_schedule("bitserial_conv2d_nchw.riscv")
def schedule_bitserial_conv2d_nchw(cfg, outs):
    return _schedule_bitserial_conv2d(cfg, outs)


@autotvm.register_topi_schedule("bitserial_conv2d_nhwc.riscv")
