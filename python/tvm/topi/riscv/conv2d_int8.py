...
@autotvm.register_topi_compute("conv2d_NCHWc_int8.riscv")
...
@autotvm.register_topi_schedule("conv2d_NCHWc_int8.riscv")
def schedule_conv2d_NCHWc_int8(cfg, outs):
    ...
    def _callback(op):
        ...
        if "conv2d_NCHWc_int8" in op.tag:
            ...
            if kh == 1 and kw == 1:
                conv2d_1x1._schedule_conv_NCHWc_int8(*args)
            else:
                conv2d_common._schedule_conv_NCHWc_int8(*args)

    traverse_inline(s, outs[0].op, _callback)
    return s


@autotvm.register_topi_schedule("conv2d_nhwc_pack_int8.riscv")
    ...
    def traverse(op):
        ...
        if "conv2d_nhwc_pack_int8" in op.tag:
            ...
            if data.dtype == "uint8":
                ...
                if kh == 1 and kw == 1:
                    conv2d_1x1._schedule_conv_nhwc_pack_int8(*args)
                else:
