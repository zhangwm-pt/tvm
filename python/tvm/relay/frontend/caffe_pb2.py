...
_BNPARAMETER_BNMODE = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name="LEARN", index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name="INFERENCE", index=1, number=1, options=None, type=None
        ),
    ],
    containing_type=None,
    options=None,
...
_POOLINGPARAMETER_POOLRUNMODE = _descriptor.EnumDescriptor(
    name="PoolRunMode",
    full_name="caffe.PoolingParameter.PoolRunMode",
    filename=None,
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name="FLOOR", index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="CEIL", index=1, number=1, options=None, type=None),
    ],
    containing_type=None,
    options=None,
...
_sym_db.RegisterEnumDescriptor(_POOLINGPARAMETER_POOLRUNMODE)
...
_BNPARAMETER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="bn_mode",
            full_name="caffe.BNParameter.bn_mode",
            index=0,
            number=3,
            type=14,
            cpp_type=8,
...
_POOLINGPARAMETER.fields_by_name["round_mode"].enum_type = _POOLINGPARAMETER_POOLRUNMODE
_POOLINGPARAMETER_POOLMETHOD.containing_type = _POOLINGPARAMETER
_POOLINGPARAMETER_POOLRUNMODE.containing_type = _POOLINGPARAMETER
